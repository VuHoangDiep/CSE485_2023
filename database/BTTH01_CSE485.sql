...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 22, 2023 lúc 05:59 PM
...
ALTER TABLE `baiviet`
  ...
  ADD KEY `baiviet_ibfk_2` (`ma_tloai`);
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `baiviet_ibfk_1` FOREIGN KEY (`ma_tgia`) REFERENCES `tacgia` (`ma_tgia`) ON DELETE NO ACTION,
